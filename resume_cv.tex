...
\definecolor{awesome}{HTML}{006494}
...
\name{Ryan}{Chee}
\address{3215 Mountain Drive, Fremont, California, 94555}
\mobile{(510) 648-7722}

\email{ryancchee@gmail.com}
...
\makecvfooter{}{Ryan Chee Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed

% \makecvfooter{\today}{Ryan Chee Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
